...
const QueueManager = {
    ...
    getQueuePosition(queueId) {
        ...
        const queues = Database.getQueues(filters);
        ...
        const estimatedWaitTime = position * (Database.getService(queue.serviceId)?.estimatedDuration || 15);
    ...
    printTicket(queueId) {
      ...
      <body>
        ...
        <div class="info">
          ...
          <div class="info-row">
            <span>Time:</span>
            <span>${queue.bookingTime ? queue.bookingDate + ' ' + queue.bookingTime : Utils.formatDate(queue.createdAt, 'time')}</span>
          </div>
          <div class="info-row">
