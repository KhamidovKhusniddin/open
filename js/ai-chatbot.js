...
const AIChatbot = {
     ...
     */
    init() {
        this.loadChatHistory(); // Load data first
        this.createChatWidget(); // Create UI
        this.renderChatHistory(); // Render loaded messages
    ...
    renderChatHistory() {
        ...
        this.messages.forEach(msg => {
            ...
            // Handle legacy time format or new Date object
            let timeStr = '';
            try {
                timeStr = new Date(msg.time).toLocaleTimeString('uz-UZ', { hour: '2-digit', minute: '2-digit' });
            } catch (e) {
                timeStr = '';
            }
